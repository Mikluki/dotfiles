...
-- Only hide numbers in non-file buffers
local should_hide_numbers = function(buftype)
	-- Show numbers only in normal file buffers (buftype == "")
	return buftype ~= ""
end
...
function update_status_column()
	for _, win in ipairs(vim.api.nvim_list_wins()) do
		...
		if should_hide_numbers(buftype) then
